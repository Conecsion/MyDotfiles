...
# RUN `npm install -g typewritten` to use this theme
...
plugins=(git autojump gh python git-prompt zsh-syntax-highlighting)
...
# >>> NVIDIA PATH CONFIG >>>
# export PATH=/opt/nvidia/nsight-compute/2022.3.0${PATH:+:${PATH}}
...
# Disable Xorg Screen Saver
# xset s 0
# xset -dpms

# Initialize Environment-modules at startup
# source /usr/share/modules/init/zsh
...
# RELION Settings
# Default PDF Viewer
# setenv RELION_PDFVIEWER_EXCUTABLE microsoft-edge
export RELION_PDFVIEWER_EXCUTABLE="microsoft-edge"
...
export PATH="/usr/bin/shaodi":$PATH
...
alias gpuinfo="watch -d -n 0.5 nvidia-smi"
